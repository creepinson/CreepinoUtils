...
public final class ReflectionUtils {
    ...
    public static Method getInnerClassMethod(String className, String innerClassName, PackageType packageType, String methodName, Class<?>... parameterTypes) throws NoSuchMethodException, ClassNotFoundException {
        return getMethod(packageType.getClass(className + "$" + innerClassName), methodName, parameterTypes);
    }
