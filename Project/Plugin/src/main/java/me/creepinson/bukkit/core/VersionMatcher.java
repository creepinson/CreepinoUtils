...
import me.creepinson.bukkit.v1_14_R1.utils.NMSWrapper1_14_R1;
	...
	public VersionWrapper match() {
		try {
			return versions.stream()
					.filter(version -> version.getSimpleName().substring(10).equals(serverVersion))
